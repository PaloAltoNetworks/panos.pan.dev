...
| Method | EndPoint                                                                       | Parameters                                                              | Example Value                           |
|-------------|--------------------------------------------------------------------------------|-------------------------------------------------------------------------|-----------------------------------------|
|     POST    | `https://<YourExpeditionIP>/api/v1/projects/{projectId}/export` | {**"projectId"**:"$projectId",<br/> With sample parameter value: **{projectID}**:"1" <br/><br/>API EndPoint Full path will become: <br/><br/>*`https://<YourExpeditionIP>/api/v1/projects/1/export`*   |{**"out:"**-> PAN-OS configuration file ,<br/><br/>**"sourceID:"**-> you can get the source id with the sources given in the previous api call<br/>} |  
