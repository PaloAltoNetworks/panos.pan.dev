...
|-------------|------------------------------------------------------------------|------------------------------|
|    GET      | <small>`https://<YourExpeditionIP>/api/v1/agent/<action>`</small> | <small>action : { start \| stop \| restart }</small> |    
|    Example  | <small>`https://10.0.0.1/api/v1/agent/restart`</small> | <small></small> |  
### Starting the Agent
