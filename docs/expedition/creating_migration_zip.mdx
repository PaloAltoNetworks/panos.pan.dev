...
| example     | <small> `https://<ExpIP>/api/v1/migration/discovery` </small>       | <small>_in body_<br/>{"vendor": "stonesoft",<br/>"config": "/tmp/myMigrationFiles/cpProviders/exported_data.xml"}</small>| |
| example     | <small> `https://<ExpIP>/api/v1/migration/discovery` </small>       | <small>_in body_<br/>{"vendor": "cp",<br/>"policy": "/tmp/myMigrationFiles/cpProviders/policy.W",<br/>"objects": "/tmp/myMigrationFiles/cpBranches/objects.C",<br/>"rulebase": "/tmp/myMigrationFiles/cpBranches/rulebases_5_0.fws"}</small>| |
