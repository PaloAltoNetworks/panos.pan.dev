...
sidebar_label: Automation Workflows Examples
hide_title: false
...
```python
print('LOGIN')
data = {"username":"anna", "password":"1234567890"}
...
The following **PHP Snippet 6** shows how to consume the Expedition API to retrieve PAN-OS Device API keys and register these API keys into the defined device.  
