...
|-------------|-----------------------------------------------------------------|------------|
| POST        | <small> `https://<ExpIP>/api/v1/mapping/discovery` </small>       | <small>_in body_<br/>{**"vendor"**: "value",<br/>**"input"**: "path to the ZIP file"}</small>|
| example     | <small> `https://<ExpIP>/api/v1/mapping/discovery` </small>       | <small>_in body_<br/>{**"vendor"**: "stonesoft",<br/>**"input"**: "/tmp/myMigrationFiles/cpProviders/exported_data.xml"}</small>| |
