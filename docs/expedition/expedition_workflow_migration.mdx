...
| Method      | EndPoint                                                   | Parameters |
|-------------|------------------------------------------------------------|------------|
|       POST  | <small>`https://<ExpIP>/api/v1/external-tools/convert`</small> |<small>_in body_<br/>{**"file"**: "path to the config file",<br/> **"out"**: "/tmp/cisco.xml",<br/>**"vendor"**: "ciscoasa" }</small>|
|    example  | <small>`https://10.0.0.1/api/v1/external-tools/convert`</small> |  <small>{**"file"**: "/var/www/html/expedition-api/contents/configSamples/CiscoCase/<br/>ciscoasa.txt",<br/> **"out"**: "/tmp/cisco.xml",<br/>**"vendor"**: "ciscoasa" }</small>|
:::info    
...
| example     | <small>`https://10.0.0.1/api/v1/projects/1/importConfig`</small>         | <small>_in url_<br/>project=1<br/><br/>_in body_<br/>{**"config"**: "/tmp/convertedCisco.xml" }</small> |
...
|     POST    | <small>`https://10.0.0.1/api/v1/projects/1/export`</small> | <small>_in url_**"projectId"**=1<br/><br/>_in body_<br/>{**"out:"**->"toExport.xml",<br/>**"sourceID:"**1}</small> |  
