...
> For more information about the PAN-OS XML API, please refer to the [official documentation](https://docs.paloaltonetworks.com/pan-os/9-0/pan-os-panorama-api/get-started-with-the-pan-os-xml-api.html) or follow the [quickstart](/docs/xmlapi_qs).
