...
|--------------------------|-------------------------------------------------------------------------------------------|--------------------------|
|    Predefined            | Predefined filtes. This do not require parameters as the logic is intrinsic to the filter | `fi1`: [address] is ipv4            |  
|    Simple                | Filters that specify                                                                      | `fi2`: [address,addressGroup] name contains 'Ala'                 |
|    Combination           | Filters that use other filters' results to evaluate the filter logic                      | `fi3`: [securityRule] source contains filter filter2              |
|    Operation             | Filters that perform boolean logic operations on other defined filters                    | `fi4`: (filter fi1 and filter fi2) or filter fi3                  |
