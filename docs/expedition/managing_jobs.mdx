...
|-------------|-----------------------------------------------------------------------|------------------------------|
|    GET      | <small>`https://localhost/api/v1/job/status/<jobId>`</small> | <small>*in url*<br/>**jobId** : job id value</small> |    
|    Example  | <small>`https://localhost/api/v1/job/status/1619`</small>              | <small>*in url*<br/> jobId: 1619</small> |  
...
| Method      | EndPoint                                                              | Parameters                   | 
|-------------|-----------------------------------------------------------------------|------------------------------|
|    DELETE   | <small>`https://localhost/api/v1/job/<jobId>`</small> | <small>*in url*<br/>**jobId** : job id value</small> |    
|    Example  | <small>`https://localhost/api/v1/job/1619`</small>              | <small>*in url*<br/> jobId: 1619</small> |  
