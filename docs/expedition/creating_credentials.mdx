...
|-------------|--------------------------------------------|------------------------------|------------------------------------------------------------------|
|    POST     | <small>`https://<YourExpeditionIP>/api/v1/login`</small>  | <small>username, password</small>           | <small>{**"username"**:"admin", **"password"**:"paloalto"}</small> |  
...
func main() {
    ...
    var ip  := "127.0.0.1" //your Expedition IP reachable from the Script execution machine
    var user := "admin"
